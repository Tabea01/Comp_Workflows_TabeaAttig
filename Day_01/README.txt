...
I tried it again at home after the course, and surprisingly got output (without changing the code, but of course with different duration of each run!), which is why I also included "day_01_test2.ipynb", in case you want to see output. I included the different runtime of the run at uni ("day_01.ipynb") and at home ("day_01_test2.ipynb") in "day_01_test2.ipynb". Also the question "What is differential abundance analysis" is explained in more depth in "day_01_test2.ipynb".
